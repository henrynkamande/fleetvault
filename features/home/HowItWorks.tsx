    ...
    <section id="how-it-works" className="bg-white py-16">
      <div className="mx-auto w-[92vw] max-w-[1280px]">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="font-title text-[clamp(2.2rem,4.8vw,4.6rem)] font-bold leading-[0.98] text-[#111827]">How {APP_NAME} Works</h2>
          <p className="mx-auto mt-3 max-w-3xl text-gray-700">
            A practical GPS-free workflow that turns daily fleet operations into auditable records, clear margins, and better decisions.
          </p>
        </div>

        <div className="mt-10 grid items-stretch gap-5 md:grid-cols-[1fr_1.05fr]">
          <article className="relative overflow-hidden rounded-3xl bg-[#2f5aab] p-6 text-white md:p-8">
            <img src={fleetImage} alt={`${APP_NAME} operational trucks`} className="absolute inset-0 h-full w-full object-cover object-center opacity-30" />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0f172a]/75 via-[#0f172a]/30 to-[#2f5aab]/45" />
            <div className="relative z-10">
              ...
              <p className="mt-3 max-w-md text-sm text-white/90 md:text-base">
                {APP_NAME} gives owners and managers visibility over trips, drivers, and profitability without surveillance-heavy workflows.
              </p>
